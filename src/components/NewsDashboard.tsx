        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse border border-gray-200">
            ...
            <tbody>
              ...
              {news.length === 0 && (
                <tr>
                  <td colSpan={6} className="border p-6 text-gray-500 text-center">
                    No news available. Click "Add News" to create your first news item.
                  </td>
                </tr>
              )}
            </tbody>
              ...
              <div>
                ...
                {newImage && (
                  <p className="text-xs text-gray-500 mt-1">
                    Selected: {newImage.name} ({(newImage.size / 1024).toFixed(1)} KB)
                  </p>
                )}
                {imageUploading && (
